...
import { ReabastecerComponent } from './Reabastecer.component';
...
describe('ReabastecerComponent', () => {
  ...
  let mockReabastecerService;
  let mockDataService

  beforeEach(async(() => {

    mockReabastecerService = sinon.createStubInstance(ReabastecerService);
    mockReabastecerService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ReabastecerService, useValue: mockReabastecerService },
